    ...
    <div className="App bg-[#F3F4FF] h-[100vh] w-full">
      ...
      <div className="grid grid-cols-5 gap-4">
        <div className="bg-[#FFFFFF] rounded-[12px] h-[315px] w-[315px]">
          <div className="font-bold text-[22px] text-[#000000] center ">
            Chart title goes here
          </div>
          <div className="center text-[16px] text-[#7C828A]">15 April - 21 April</div>
          <Lines />
        </div>
        <div className="bg-[#FFFFFF] rounded-[12px] h-[315px] w-[315px]">
          <div className="font-bold text-[22px] center">Chart title</div>
          <div className="center text-[16px] text-[#7C828A]">Here go numbers XX of total XX</div>
          <Circle />
        </div>
        <div className="bg-[#FFFFFF] rounded-[12px] h-[315px] w-[315px]">
